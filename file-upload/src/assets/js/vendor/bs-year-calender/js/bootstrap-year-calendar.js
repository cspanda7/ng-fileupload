...
(function ($) {
	...
	Calendar.prototype = {
		...
		_renderHeader: function () {
			...
			// custom code for calender menu
			$(".calendar-header").append('<div class="calender-menu"><p>Viewby </p> <a href = "calender-year.html"> Year </a><a href = "calender-month.html"> Month </a></div>');
		},
	...
	var colors = $.fn.calendar.colors = ['#bbf5d4'];
